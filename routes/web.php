...
Route::middleware('auth')->group(function () {
    ...
    // Account Management (Master Admin Only)
    Route::middleware('can:manage-users')->group(function () {
        ...
        Route::put('/accounts/{user}', [\App\Http\Controllers\AccountController::class, 'update'])->name('accounts.update');
        Route::delete('/accounts/{user}', [\App\Http\Controllers\AccountController::class, 'destroy'])->name('accounts.destroy');
    });
